...
print("Added workspace directory to sys.path")
print("Added rs485sim directory to sys.path")
...
try:
    ...
    print("Successfully imported ModbusSerialServer")
except ImportError as e:
    print(f"Failed to import ModbusSerialServer: {e}")
    sys.exit(1)
...
try:
    ...
    try:
        ...
        print(f"Failed to run pytest via subprocess: {sub_error}")
        sys.exit(1)
